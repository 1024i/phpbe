...
class home extends \system\template
{
...
jQuery(document).ready(function($) {
	...
	{
		$latest_thumbnail_articles = $this->get('latest_thumbnail_articles');
	...
	{
		$active_users = $this->get('active_users');
		$month_hottest_articles = $this->get('month_hottest_articles');
