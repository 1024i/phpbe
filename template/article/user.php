...
class template_article_user extends theme
{
	...
	parent::head();
	?>
<script type="text/javascript" language="javascript" src="<?php echo URL_ROOT; ?>/template/article/js/user.js"></script>
<link type="text/css" rel="stylesheet" href="<?php echo URL_ROOT; ?>/template/article/css/user.css">
...
.theme-center .profile .profile_item_value_border{border:<?php echo $this->get_color(5); ?> 1px solid; background-color:<?php echo $this->get_color(9); ?>;margin-top:5px;}
	...
	{
		parent::middle(array('west'=>0, 'east'=>0));
	}
