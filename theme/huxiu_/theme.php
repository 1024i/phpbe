...
class theme extends template
{
	...
	protected $primary_color = '#2D2D2D';		// 主题 主色
...
<link rel="stylesheet" href="<?php echo BONE_URL; ?>/themes/huxiu/css/bone.css" />
<script src="<?php echo BONE_URL; ?>/themes/huxiu/js/bone.js"></script>

<script src="<?php echo BONE_URL; ?>/js/global.js"></script>

<link rel="stylesheet" href="<?php echo BONE_URL; ?>/themes/huxiu/css/theme.css" />
<script src="<?php echo BONE_URL; ?>/themes/huxiu/js/theme.js"></script>
...
<div class="row">
	<div class="col-3">
		<img src="<?php echo BONE_URL; ?>/themes/huxiu/images/logo.gif" alt="<?php echo $config->site_name; ?>" />
	</div>
	<div class="col-17">
