...
tinymce.PluginManager.add('adminimage', function(editor) {
	...
	function showDialog(imageList) {
		...
		function openmanager()
		{
			editor.windowManager.open({
				...
				file: './?controller=system_filemanager&action=browser&filter_image=1&src_id=img',
				width: 880,
				height: 600
			})
		}
		...
		var generalFormItems = [
            {
				...
				direction: 'row',
					items: [
						{name: 'src', type: 'filepicker', filetype: 'image',size: 35, classes:'input_img_src', label: 'Source', autofocus: true, onchange: srcChange},
						{name: 'btn_filemanager', type: 'button', icon: 'browse',onclick: openmanager, tooltip: 'Uploaded images'}
				]
			},
			imageListCtrl,
