...
if ($config_system->offline === '1') be_exit($config_system->offline_message);
...
if ($instance === null) {
    if (request::is_ajax()) {
        ...
        $response->redirect_url = URL_ROOT . '/404.html';
