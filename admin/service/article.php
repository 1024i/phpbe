    ...
    public function delete($ids)
    {
        ...
        try {
            ...
            foreach ($array as $id) {
                ...
                if ($row_article->thumbnail_l != '') $files[] = PATH_DATA . DS . 'article' . DS . 'thumbnail' . DS . $row_article->thumbnail_l;
                if ($row_article->thumbnail_m != '') $files[] = PATH_DATA . DS . 'article' . DS . 'thumbnail' . DS . $row_article->thumbnail_m;
                if ($row_article->thumbnail_s != '') $files[] = PATH_DATA . DS . 'article' . DS . 'thumbnail' . DS . $row_article->thumbnail_s;
