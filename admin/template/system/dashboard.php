...
class dashboard extends \admin\theme
{
...
<script type="text/javascript" language="javascript" src="template/system/js/dashboard.js"></script>
	...
	protected function center()
	{
		...
		$user = $this->get('user');		
		$recent_logs = $this->get('recent_logs');
		$user_count = $this->get('user_count');
		$app_count = $this->get('app_count');
		$theme_count = $this->get('theme_count');
			...
			<div class="span6">
				...
				<div class="box">
					...
					<tr>
						...
						<td valign="top">
							<p>您好 <span style="font-weight:bold; color:red;"><?php echo $user->name; ?></span>(<?php echo $admin_config_user_group->names[$my->group_id]; ?>), 欢迎回来。</p>
