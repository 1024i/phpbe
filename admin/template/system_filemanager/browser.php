<?php
namespace admin\template\system_filemanager;

class browser extends \admin\system\theme
{
		...
		<form action="./?controller=system_filemanager&task=upload_file" method="post" class="form-horizontal" enctype="multipart/form-data">
			<div class="modal hide fade" id="modal-upload" data-backdrop="static">
				...
				<div class="modal-body">
					...
					<div class="control-group">
						<div class="controls"><label class="checkbox"><input type="checkbox" name="watermark" value="1"<?php echo $config_system_watermark->watermark == '0'?'':' checked="checked"'; ?> />图片添加水印</label></div>
					</div>
					<div class="control-group">
