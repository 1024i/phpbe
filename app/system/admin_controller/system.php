...
class system extends \system\admin_controller
{
    ...
    public function menus_save()
    {
        ...
        $service_system_cache = be::get_service('system.cache');
        $service_system_cache->update_menu($row_system_menu_group->class_name);
    ...
    public function clear_cache()
    {
        ...
        $service_system_cache = be::get_service('system.cache');
        $service_system_cache->clear($type);
