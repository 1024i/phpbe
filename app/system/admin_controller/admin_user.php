...
class admin_user extends \system\admin_controller
{
    ...
    public function ajax_login_check()
    {
        ...
        $admin_service_admin_user = be::get_service('system.admin_user');
    ...
    public function edit_save()
    {
        ...
        $config_user = be::get_config('system.admin_user');
    ...
    public function setting()
    {
        ...
        response::set('config_admin_user', be::get_config('system.admin_user'));
        response::display();
    }
