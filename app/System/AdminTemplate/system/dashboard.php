        ...
        <div class="box">
            <div class="box-title">
                ...
                <tr>
                    ...
                    <td style="text-align:right; padding-right:10px;"><a href="./?app=System&controller=System&action=logs" title="查看更多系统操作日志" data-toggle="tooltip" class="text-info">更多...</a></td>
                </tr>
                </table>
            </div>
            <div class="box-body">
