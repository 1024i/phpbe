...
?>
<link type="text/css" rel="stylesheet" href="/app/Cms/Template/Article/css/bjqs.css">
<script type="text/javascript" language="javascript" src="/app/Cms/Template/Article/js/bjqs-1.3.min.js"></script>

<link type="text/css" rel="stylesheet" href="/app/Cms/Template/Article/css/home.css">
<script type="text/javascript" language="javascript" src="/app/Cms/Template/Article/js/home.js"></script>
        ...
        <div id="banner-fade">
            <ul class="bjqs">
                ...
                foreach ($latestThumbnailArticles as $article) {
                    ?>
                    <li>
                        <a href="<?php echo url('app=Cms&controller=Article&action=detail&articleId=' . $article->id); ?>"
                           title="<?php echo $article->title; ?>">
                            <img src="<?php echo Be::getRuntime()->getUrlData() . '/Article/Thumbnail/' . $article->thumbnailL; ?>"
    ...
    <div class="col-12">
        ...
        <div class="top-articles">
            ...
            if (count($topArticles)) {
                ...
                ?>
                <h4><a href="<?php echo url('app=Cms&controller=Article&action=detail&articleId=' . $article->id); ?>"
                       title="<?php echo $article->title; ?>"><?php echo $article->title; ?></a></h4>
                <div class="summary"><?php echo $article->summary; ?><a
                            href="<?php echo url('app=Cms&controller=Article&action=detail&articleId=' . $article->id); ?>"
    ...
    <div class="theme-box-container">
        <div class="theme-box">
            <div class="theme-box-title"><?php echo $category->name; ?><a
                        href="<?php echo url('app=Cms&controller=Article&action=articles&categoryId=' . $category->id); ?>"
                    ...
                    <div class="row">
                        ...
                        if ($categoryThumbnailArticle == null) {
                            ...
                            <div class="col-5 text-center">
                                <a href="<?php echo url('app=Cms&controller=Article&action=detail&articleId=' . $categoryThumbnailArticle->id); ?>"
                                   title="<?php echo $categoryThumbnailArticle->title; ?>">
                                    <img src="<?php echo Be::getRuntime()->getUrlData() . '/Article/Thumbnail/' . $categoryThumbnailArticle->thumbnailM; ?>"
                        ...
                        foreach ($activeUsers as $activeUser) {
                            ...
                            <li style="width:<?php echo $configUser->avatarMW; ?>px;">
                                <div class="active-user-avatar">
                                    <a href="<?php echo url('app=Cms&controller=Article&action=user&userId=' . $activeUser->id); ?>"
                                       title="查看 <?php echo $activeUser->name; ?> 的动态">
                                        <img src="<?php echo Be::getRuntime()->getUrlData() . '/user/avatar/' . (isset($activeUser->avatarM) ? $activeUser->avatarM : ('default/' . $configUser->defaultAvatarM)); ?>"
                ...
                foreach ($monthHottestArticles as $article) {
                    ...
                    <div class="month-hottest-article">
                        ...
                        <div class="month-hottest-article-thumbnail"
                            ...
                            <a href="<?php echo url('app=Cms&controller=Article&action=detail&articleId=' . $article->id); ?>"
                               title="<?php echo $article->title; ?>">
                                <img src="<?php echo Be::getRuntime()->getUrlData() . '/Article/Thumbnail/'; ?><?php echo $article->thumbnailS == '' ? ('default/' . $configArticle->defaultThumbnailS) : $article->thumbnailS; ?>"
