            ...
            <div class="theme-center">
                ...
                if (count($articles)) {
                    ...
                    if ($pagination->getPage() == 1) {
                        ...
                        ?>
                        <h4 class="head-article-title"><a href="<?php echo url('app=Cms&controller=Article&task=detail&articleId='.$article->id); ?>" title="<?php echo $article->title; ?>"><?php echo $article->title; ?></a></h4>
                    ...
                    foreach ($articles as $article) {
                        ...
                        <div class="article">
                            ...
                            <div style="margin-left:<?php echo $configArticle->thumbnailMW; ?>px;">
                                <h4 class="article-title"><a href="<?php echo url('app=Cms&controller=Article&task=detail&articleId='.$article->id); ?>" title="<?php echo $article->title; ?>"><?php echo $article->title; ?></a></h4>
                                ...
                                foreach ($hottestArticles as $article) {
                                    ...
                                    <div class="hottest-article">
                                        ...
                                        <div style="margin-left:<?php echo $configArticle->thumbnailSW; ?>px;">
                                            <h5 class="hottest-article-title"><a href="<?php echo url('app=Cms&controller=Article&task=detail&articleId='.$article->id); ?>" title="<?php echo $article->title; ?>"><?php echo $article->title; ?></a></h5>
                            ...
                            <div class="theme-box-body">
                                ...
                                foreach ($topArticles as $article) {
                                    ...
                                    <div class="top-article">
                                        ...
                                        <div style="margin-left:<?php echo $configArticle->thumbnailSW; ?>px;">
                                            <h5 class="top-article-title"><a href="<?php echo url('app=Cms&controller=Article&task=detail&articleId='.$article->id); ?>" title="<?php echo $article->title; ?>"><?php echo $article->title; ?></a></h5>
