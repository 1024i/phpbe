...
<div style="border:#eee 1px solid; border-left:<?php echo $this->primaryColor; ?> 5px solid;  background-color:#FFFFFF; padding:20px; box-shadow:1px 1px 3px #ccc;">
    <div class="row">
        <div class="col-3 text-center">
            <img src="<?php echo URL_ROOT.'/'.DATA.'/user/avatar/'.($user->avatarL == ''?('default/'.$configUser->defaultAvatarL):$user->avatarL); ?>" alt="<?php echo $user->name; ?>" />
        ...
        ?>
            <div class="article">
                <div class="article-thumbnail" style="width:<?php echo $configArticle->thumbnailSW; ?>px; height:<?php echo $configArticle->thumbnailSH; ?>px;">
                    ...
                    <img src="<?php echo URL_ROOT.'/'.DATA.'/Article/Thumbnail/'; ?><?php echo $article->thumbnailS == ''?('default/'.$configArticle->defaultThumbnailS):$article->thumbnailS; ?>" alt="<?php echo $comment->article->title; ?>" />
                    </a>
                </div>
